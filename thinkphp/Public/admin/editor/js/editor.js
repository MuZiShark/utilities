...
if(isUndefined(editorcurrentheight))
	var editorcurrentheight = 450;
...
function editorcontrolpos() {
	...
	if(scrollTop > editorcontroltop && editorcurrentheight > 100) {
...
function editorsize(op, v) {
	...
	editorcurrentheight = editorheight > 100 ? editorheight : 100;
	if($(editorid + '_iframe')) {
		$(editorid + '_iframe').contentWindow.document.body.style.height = editorcurrentheight + 'px';
		$(editorid + '_iframe').style.height = (editorcurrentheight + 20) + 'px';
	}
	if(framemObj) {
		framemObj.style.height = (editorcurrentheight + 20) + 'px';
	}
	...
	if(wysiwyg) {
		...
		if(initialized && !(BROWSER.firefox && BROWSER.firefox >= '3' || BROWSER.opera)) {
			...
			text = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
				...
				'<link rel="stylesheet" type="text/css" href="'+STATICURL+'editor/css/wysiwyg.css" />' +
