...
function showEditorMenu(tag, params) {
	...
	if(menu) {
		...
		menu.innerHTML = '<div class="p_opt cl"><span class="y" style="margin:-10px -10px 0 0"><a onclick="hideMenu()" class="flbc" href="javascript:;">关闭</a></span><div>' + str + '</div><div class="pns mtn" style="float:left"><button type="submit" id="' + ctrlid + '_submit" class="pn pnc"><strong>提交</strong></button><button type="submit" onClick="hideMenu()" class="pn"><em>取消</em></button></div></div>';
